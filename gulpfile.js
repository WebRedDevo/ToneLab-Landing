...
return gulp.src('frontend/assets/fonts/Circe/*')
...
gulp.watch(['frontend/components/*/*.styl','frontend/stylus/*.styl','frontend/stylus/*/*.styl','frontend/stylus/**/*.styl','frontend/stylus/***/*.styl'],gulp.series('stylus'))
